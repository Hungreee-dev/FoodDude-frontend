...
const index = ({ rating, profile_link, review, photoURL, username }) => {
    ...
    return (
        <div className="review_card shadow">
            <div className="review_card_user">
                <a href={profile_link} target="_blank" rel="noreferrer">
                    <img className="reviewcard_user_photo" src={photoURL} alt={`${username}'s profile'`} />
