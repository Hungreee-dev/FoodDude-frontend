    ...
    render() {
        return (
            <div className={this.props.className} style={{ marginBottom: '-30px' }}>
                {this.props.image ? <img alt="" src={this.props.image} className={this.props.imageClass} /> : ''}
                <h6 className="mb-0">{this.props.title}</h6>
                {this.props.subTitle ? <p className="text-secondary mb-0">{this.props.subTitle}</p> : ''}
                {this.props.linkUrl ? (
                    <small>
                        <Link className="text-primary font-weight-bold" to={this.props.linkUrl}>
                            {this.props.linkText}
                        </Link>
                    </small>
                ) : (
