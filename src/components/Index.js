            ...
            <Row>
              <Col md={4} xs={6}>
                ...
                >
                  ...
                  <p class="mb-0 mt-2 font-italic">
                    "The tastiest food doesn't have to be the costliest. In
                    these tough times, it may be very hard for us to spend every
                    time we crave something delicious. Fooddude promises to be
                    the most affordable option you have to satisfy your hunger."
                  </p>
                </blockquote>
              </Col>
              <Col md={4} xs={6}>
                ...
                >
                  ...
                  <p class="mb-0 mt-2 font-italic">
                    "Fooddude provides you the best food ranging from several
                    cuisines from the best kitchens throughout the city. We
                    assure you of satisfying your palette minus the food colours
                    and unnecessary oil."
                  </p>
                </blockquote>
              </Col>
              <Col md={4} xs={6}>
                ...
                >
                  ...
                  <p class="mb-0 mt-2 font-italic">
                    "The pandemic has forced us to rethink our sanitary
                    practices. But, Fooddude promises that you'll never have to
                    think twice while ordering from us. Our delivery agents are
                    checked and sanitized regularly and use masks and gloves
                    throughout the process to ensure your food reaches to you
                    safely."
                  </p>
                </blockquote>
              </Col>
          ...
          <Container>
            ...
            <Row>
              <Col md={12}>
                ...
                >
                  <div style={{ background: "red" }} className="item">
                    <CardItem
                      title="World Famous"
                  ...
                  <div style={{ background: "hotpink" }} className="item">
                    <CardItem
                  ...
                  <div style={{ background: "blue" }} className="item">
                    <CardItem
                  ...
                  <div style={{ background: "black" }} className="item">
                    <CardItem
                      title="Polo Lounge"
                      subTitle="North Indian • American • Pure veg"
                      imageAlt="Product"
